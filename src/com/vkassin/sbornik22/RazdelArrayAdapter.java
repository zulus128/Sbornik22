...
//	private int resourceId;
	...
	public RazdelArrayAdapter(Context context, int resourceId, ArrayList<RazdelItem> objects) {
...
//		this.resourceId = resourceId;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	if (item != null) {
    		...
    		TextView title = (TextView) convertView.findViewById(R.id.RazdelNameTextView);
    		TextView text = (TextView) convertView.findViewById(R.id.RazdelTextView);
